...
public class ImplementationAdapter {
    ...
    static {
        try {
            ...
            Class c = Class.forName("io.paradaux.chestshop.breeze.utils.implementationfeatures.NonSnapshotInventoryHolder");
        ...
        try {
            ...
            Class c = Class.forName("io.paradaux.chestshop.breeze.utils.implementationfeatures.NonSnapshotState");
