package io.paradaux.chestshop.Listeners.Block.Break;
...
import io.paradaux.chestshop.Listeners.Block.Break.Attached.PhysicsBreak;
...
public class SignBreak implements Listener {
    ...
    public SignBreak() {
        try {
            ...
            ChestShop.getPlugin().registerEvent((Listener) Class.forName("io.paradaux.chestshop.Listeners.Block.Break.Attached.PaperBlockDestroy").getDeclaredConstructor().newInstance());
