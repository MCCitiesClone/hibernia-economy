...
public interface FirmRequestService {
    ...
    void acceptEmploymentOffer(String firmName, UUID playerId);
    void rejectEmploymentOffer(String firmName, UUID playerId);
    ...
    UUID rejectTransferProprietorship(String firmName, UUID newProprietorId);
